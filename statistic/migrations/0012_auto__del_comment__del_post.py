...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'statistic_comment')

        # Deleting model 'Post'
        db.delete_table(u'statistic_post')


    def backwards(self, orm):
        # Adding model 'Comment'
        db.create_table(u'statistic_comment', (
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['statistic.Post'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'statistic', ['Comment'])

        # Adding model 'Post'
        db.create_table(u'statistic_post', (
            ('body', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'statistic', ['Post'])
