...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.nomer'
        db.add_column(u'statistic_userprofile', 'nomer',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nomer'
        db.delete_column(u'statistic_userprofile', 'nomer')
    ...
    models = {
        ...
        u'statistic.userprofile': {
            ...
            'nomer': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
