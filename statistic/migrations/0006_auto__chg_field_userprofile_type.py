...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.type'
        db.alter_column(u'statistic_userprofile', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'UserProfile.type'
        db.alter_column(u'statistic_userprofile', 'type', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'statistic.userprofile': {
            ...
            'nomer': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
