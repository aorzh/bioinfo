...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.kreat'
        db.alter_column(u'statistic_userprofile', 'kreat', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.kreat'
        db.alter_column(u'statistic_userprofile', 'kreat', self.gf('django.db.models.fields.IntegerField')())
