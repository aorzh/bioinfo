...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'statistic_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Post.title'
        db.alter_column(u'statistic_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))
