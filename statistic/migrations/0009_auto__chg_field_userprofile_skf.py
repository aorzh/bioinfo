...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.skf'
        db.alter_column(u'statistic_userprofile', 'skf', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.skf'
        db.alter_column(u'statistic_userprofile', 'skf', self.gf('django.db.models.fields.IntegerField')())
